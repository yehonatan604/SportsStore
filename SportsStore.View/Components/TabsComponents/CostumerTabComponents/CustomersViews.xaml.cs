...
namespace SportsStore.View.Themes.CustomControls.CostumerTabCComponents
{
    public partial class CustomersViews : UserControl
    {
        ...
        public CustomersViews()
        {
            InitializeComponent();
            handler = new();
            new SaleEntityHandler().GetList("ByDate").ForEach(x => CmbBoxByDate.Items.Add(x));
        }
        ...
        private void BtnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            dGrid.ItemsSource = byId ? handler.GetTable
        ...
        {
            MainWindow.Current.Dgrid3.ItemsSource = handler.Search("", BoxSearch.Text).ToList();
        }
    }
}
